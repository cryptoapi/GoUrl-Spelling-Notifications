...
<head>
	...
	<body onload=loaddata()>
		<div class="container">
			...
			<div class="pull-right" style="margin:-44px -10px 0 0;"><a href="javascript:void(0)" onclick="hide()" title="Close" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-remove"></span></a></div>
